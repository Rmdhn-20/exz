...
const starts = async (kurr = new WAConnection()) => {
    ...
    kurr.browserDescription = [ 'exz', 'Chrome', '3.0' ]
...
if (!welkom.includes(anu.jid)) return
		try {
		    fkontakk = { key: {
		    fromMe: false,
		    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6289618777587-6281220670449@g.us' } : {})
		    },
		    message: {
		    "contactMessage":{"displayName":fake,"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;exz;;;\nFN:exz\nitem1.TEL;waid=6289618777587:+62 896-1877-7587\nitem1.X-ABLabel:Mobile\nEND:VCARD"
		     }}}
...
"message": {
"groupInviteMessage": {
"groupJid": "6289618777587-1620319322@g.us",
